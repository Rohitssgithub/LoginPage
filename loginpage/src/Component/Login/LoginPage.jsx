                                        ...
                                        <Form Form onSubmit={handleSubmit}>
                                            <div className={styles.emailSenderDiv}>
                                                <div className={styles.inputGroup}>
                                                    ...
                                                    <input type='email' value={values.password} name="password" onChange={handleChange} onBlur={handleBlur} placeholder='Captcha'
                                                        id="floatingInput" className={`form-control  inp  ${errors.password && touched.password && 'is-invalid'}`} />
                                                    {
                                                        errors.password && touched.password ?
                                                            <p className={styles.errorMessage}>{errors.password}</p> : null
                                            ...
                                            <button className='btn btn-danger' onClick={refreshCaptcha}>Generate Captcha</button>
                                        </Form>
                                    )}
                                </Formik>
                            </div>
